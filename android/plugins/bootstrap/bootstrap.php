...
class bootstrap {
  ...
  public function alert ($text = "Текст уведомление" , $type = 'default', $align = 'left') {
    return "<div class='alert alert-$type alert-dismissible show' role='alert' align='$align'>$text<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button></div>";
  }
     ...
     * $align - Распаложение
     */
    public function panel (array $options = ['content', 'title', 'theme', 'stretch', 'align']) {
        $optionsOLD = [
        ...
        if ($stretch == true) {
            return "
                <div class='panel panel-$theme' style=\"width: -moz-max-content;\">
                    <div class='panel-heading' align='$align'>$title</div>
                    <div class='panel-body' align='$align'>
                        $content
                    </div>
                </div>";
        } else {
 ...
 ,'modalType', 'href', 'theme']) {
        ...
        if($menu != null && $modal == true) {
            return "<div class='btn-group' style='$style'>
                <button onclick=\"location.href = '$href'\" type='button' data-dismiss='modal' class='btn btn-$theme dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' style='$style'>
                $title
            ...
            if ($href != null) {
              return "<div class='btn-group' style='$style'>
                <button onclick=\"location.href = '$href'\" type='button' class='btn btn-$theme dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' style='$style'>
                $title
                <span class='caret'></span>
                </button>
                $menu
              ...
              return "<div class='btn-group' style='$style'>
                <button type='button' class='btn btn-$theme dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' style='$style'>
                $title
                <span class='caret'></span>
                </button>
                $menu
            ...
            if ($modal == true) {
                if ($modalType == 'exit') {
                    if ($href != null) {
                      return "<button onclick=\"location.href = '$href'\" type='$type' data-dismiss='modal' id='$id' class='btn btn-$theme' data-toggle='modal' data-target='#$id' style='$style'>$title</button>";
                    } else {
    ...
    public function form (array $options = [
        ...
        echo "
        <!-- Форма диалоговое -->
        <div class='modal fade' id='$id' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' style='margin-block-end: 0em;'>
    ...
    public function combobox (array $options = ['option', 'id', 'theme']) {
        ...
        return "<p><select class='panel-$theme form-control' name='$id'>$option</select></p>";
    }
     ...
     * $type - тип
     */
    public function span ($text = "Текст", $type = "default") {
